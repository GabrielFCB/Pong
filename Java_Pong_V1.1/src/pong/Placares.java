...
public class Placares extends Tela {
    ...
    public Placares() throws SaveException{
        lista=new ArrayList<>();
    ...
    public void salvarLista(String nomeArquivo) throws SaveException {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(nomeArquivo))) {
            ...
            throw new SaveException("Erro em salvar Score. Arquivo Inexistente", e);
        }
    }

    public void carregarLista(String nomeArquivo) throws SaveException {
        try (BufferedReader reader = new BufferedReader(new FileReader(nomeArquivo))) {
            ...
            while ((line = reader.readLine()) != null) {
             ...
             throw new SaveException("Erro em carregar Score. Arquivo Inexistente", e);
        }
    }


    public static List<Entry> getLista() {
        return lista;
    }


    public static void setLista(List<Entry> lista) {
        Placares.lista = lista;
    }


    @Override
    public String toString() {
        return "Placares [largura="+largura+", altura="+altura+"]";
    }
