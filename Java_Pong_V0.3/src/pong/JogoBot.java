...
public class JogoBot extends Jogo {
    public static Bot bot = new Bot(largura - 15 - jogador1.larguraJogador, 165);
    public static Bola bola = new Bola((largura - Bola.larguraBola) / 2, (altura - Bola.alturaBola) / 2, false);
    ...
    public void atualizar() {
        ...
        if (bola.pontoJogador1) {
            ...
            bot = new Bot(largura - 15 - jogador1.larguraJogador, 165);
            bola = new Bola((largura - Bola.larguraBola) / 2, (altura - Bola.alturaBola) / 2, false);
        }
