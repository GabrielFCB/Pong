...
public class TelaInicial extends Canvas implements Runnable, KeyListener{
    ...
    public Jogo jogo1;
    public boolean jogoBot=false;
    public boolean jogo2Jogador=false;
    ...
    public void keyPressed(KeyEvent e) { // O que fazer se a tecla for apertada
        ...
        if ((jogoBot)||(jogo2Jogador)){
            if (e.getKeyCode() == KeyEvent.VK_W) {
                jogo1.jogador1.up=true;
            }
            if (e.getKeyCode() == KeyEvent.VK_S) {
                jogo1.jogador1.down=true;
            }
        }

        if ((jogo2Jogador)){
            if (e.getKeyCode() == KeyEvent.VK_W) {
                jogo1.jogador2.up=true;
            }
            if (e.getKeyCode() == KeyEvent.VK_S) {
                jogo1.jogador2.down=true;
            }
        }
    ...
    public void keyReleased(KeyEvent e) { // O que fazer se a tecla for solta
        if ((jogoBot)||(jogo2Jogador)){
            if (e.getKeyCode() == KeyEvent.VK_W) {
                jogo1.jogador1.up=false;
            }
            if (e.getKeyCode() == KeyEvent.VK_S) {
                jogo1.jogador1.down=false;
            }
        }
    }
