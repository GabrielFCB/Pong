...
public class Bola {
    ...
    public void atualizar (){
        ...
        Rectangle bola = new Rectangle((int)contatoX,(int)contatoY,larguraBola,alturaBola);//classe que lida com Retangulo
        Rectangle jogador1 = new Rectangle(Jogo.jogador1.x,Jogo.jogador1.y,Jogo.jogador1.larguraJogador,Jogo.jogador1.alturaJogador);
        Rectangle jogador2 = new Rectangle(Jogo2Jogador.jogador2.x,Jogo2Jogador.jogador2.y,Jogo2Jogador.jogador2.larguraJogador,Jogo2Jogador.jogador2.alturaJogador);
